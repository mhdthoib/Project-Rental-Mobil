      ...
      <div>
          ...
          <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
            <div class="w-full">
              ...
              <div class="mt-2 text-sm text-gray-500">
                Nama bookings. Contoh: booking, booking 2, booking 3, dsb. Wajib diisi. Maksimal 255 karakter.
              </div>
            </div>
          </div>
        ...
        <div class="w-full">
          ...
          <input value="{{ old('city') ?? $booking->city }}" name="city"
                 class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                 id="grid-last-name" type="text" placeholder="City" required>
          <div class="mt-2 text-sm text-gray-500">
            Kota bookings.  Contoh : Lhokseumawe.
          </div>
        </div>
      </div>
      ...
      <div class="w-full">
        ...
        <div class="w-full">
          ...
          <select name="status" id="status" class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500" required>
                 ...
                 <option value="1" {{ $booking->status == 1 ? 'selected' : '' }}>Diterima</option>
                 <option value="2" {{ $booking->status == 2 ? 'selected' : '' }}>Ditolak</option>
                 </select>
                 ...
                 <div class="w-full">
                  ...
                  <select name="payment_status" id="payment_status" class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500" required>
                         <option value="0" {{ $booking->payment_status == 0 ? 'selected' : '' }}>Pending</option>
                         <option value="1" {{ $booking->payment_status == 1 ? 'selected' : '' }}>Success</option>
                         <option value="2" {{ $booking->payment_status == 2 ? 'selected' : '' }}>Failde</option>
                        <option value="3" {{ $booking->payment_status == 3 ? 'selected' : '' }}>Expired</option>
                         </select>

          <div class="mt-2 text-sm text-gray-500">
            Status Pembayaran. Contoh: Pending, Success, Failed, Expired.
          </div>
        </div>
      </div>
